...
/**
 * The {@code Jomar.SidePanel} class is responsible for displaying various information
...
public class SidePanel extends JPanel {
	...
	/**
	 * The Jomar.Tetris instance.
	 */
	private Tetris tetris;
	
	/**
	 * Creates a new Jomar.SidePanel and sets it's display properties.
	 * @param tetris The Jomar.Tetris instance to use.
	 */
